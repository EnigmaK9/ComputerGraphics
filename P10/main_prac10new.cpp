		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glPushMatrix();
					...
					glRotatef(giro_llanta, 1.0f, 0.0f, 0.0f);
					llanta.GLrender(NULL,_SHADED,1.0);  // Mando llamar la llanta para ser dibujada - Llanta Delantera-Der
				glPopMatrix();
				...
				glPushMatrix();
					...
					glRotatef(-giro_llanta, 1.0f, 0.0f, 0.0f);
					llanta.GLrender(NULL, _SHADED, 1.0);  // Mando llamar la llanta para ser dibujada - Llanta Delantera-Izq
				glPopMatrix();
				
				glPushMatrix();
					glTranslatef(-6.0, -1.0, -9.5);
					glRotatef(giro_llanta, 1.0f, 0.0f, 0.0f);
					llanta.GLrender(NULL, _SHADED, 1.0);  // Mando llamar la llanta para ser dibujada - Llanta Trasera-Der
				glPopMatrix();
				...
				glPushMatrix();
					...
					glRotatef(180.0f, 0.0f, 1.0f, 0.0f);
					glRotatef(giro_llanta, -1.0f, 0.0f, 0.0f);
					llanta.GLrender(NULL, _SHADED, 1.0);  // Mando llamar la llanta para ser dibujada - Llanta Trasera-Izq
				glPopMatrix();
...
int main ( int argc, char** argv )   // Main Function
{
  ...
  glutCreateWindow    ("Practica 10 20201"); // Nombre de la Ventana
